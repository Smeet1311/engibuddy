...
import { MoreVertical, PanelLeftClose, PanelLeftOpen, Pencil, Plus, Search, Trash2 } from 'lucide-react'
              ...
              {filteredSessions.map((session) => (
                ...
                >
                  ...
                  {menuOpenId === session.sessionId && (
                    <div className="absolute right-2 top-8 z-50 min-w-[130px] rounded-md border border-gray-200 bg-white py-1 shadow-lg">
                      <button
                        type="button"
